...
with open('Day1/input.txt') as f:
    ...
    print("Total Items checked: {}".format(total_calorie_items))
    print("Total Groups: {}".format(total_calorie_groups))
    print("Total Calories: {}".format(total_calories))
    print("Smallest Calorie group: {}".format(min_calories))
    print("Largest Calorie group: {}".format(max_calories))
    print("Average Calories: {}".format(total_calories / total_calorie_groups))
