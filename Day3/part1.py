...
with open('input.txt') as f:
    ...
    for line in lines:
        ...
        first_string, second_string = line_clean[:len(line_clean)//2], line_clean[len(line_clean)//2:]
        match_value = find_match(first_string, second_string)
        total_value += match_value
        # print("{} -> {},{} ".format(line, first_string, second_string))

    print ("Total value of matching items = {}".format(total_value))
